...
RADIO_GPIO_CE = config.get("Radio", "gpio_ce")
...
def init_radio(hostname: str, port: int, gpio: int, address: str) -> nrf.NRF24:
    ...
    nrf = nrf.NRF24(pi, ce=gpio, payload_size=RF24_PAYLOAD.DYNAMIC, channel=100, data_rate=RF24_DATA_RATE.RATE_250KBPS, pa_level=RF24_PA.LOW)
